...
<body>
    ...
    <main>
        <section class="section-info">
            ...
            $getplaylistname = $mysqli->query($playlistname);
            ...
            <div class="section-name">
                    ...
                    <div class="playlist-owner">
                        ...
                        <a id="playlist-delete" class="info-modify" href="process_edit.php?m=d&id=<?php echo $_GET["playlist_id"]; ?>">Delete</a>
                    </div>
                    <?php } ?>
            ...
            <!-- query all songs of this artist and display here -->
                <div class="song-container">
                    <table class="song-table">
                        ...
                        $getplaylistsong = $mysqli->query($playlistsong);
                        $no=1;
                        if (!$getplaylistsong) {
                            echo "failed " . $mysqli->error;
                        }
                        ...
                        <tr class="tr-data">
                            ...
                            <td class="td-song-title">
                                ...
                                <div class="song-content">
                                    <a class="song-title" href="<?php echo $_SERVER["SCRIPT_NAME"] ?>?playlist_id=<?php echo $_GET["playlist_id"] ?>&m_id=<?php echo $rows['m_id'] ?>"><?php echo $rows["music_name"]?></a>
